...
'step 6'
WebUI.setText(findTestObject('Object Repository/Register/input_Register Email'), Email2)

'step 7'
WebUI.setEncryptedText(findTestObject('Register/input_Register Password'), Password_wrong)

'step 8'
WebUI.setEncryptedText(findTestObject('Register/input_Repeat Password'), Password_wrong)
